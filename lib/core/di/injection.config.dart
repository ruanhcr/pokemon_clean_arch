...
import '../../pokemon/data/datasources/remote/i_pokemon_remote_data_source.dart'
    as _i752;
import '../../pokemon/data/datasources/remote/pokemon_remote_data_source_impl.dart'
    as _i685;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  Future<_i174.GetIt> init({
    ...
    gh.factory<_i234.IPokemonLocalDataSource>(
      () => _i1036.PokemonLocalDataSourceImpl(
        gh<_i979.Box<_i332.PokemonHiveModel>>(instanceName: 'favorites_box'),
      ),
    );
    ...
    gh.factory<_i752.IPokemonRemoteDataSource>(
      () => _i685.PokemonRemoteDataSourceImpl(gh<_i682.RestClient>()),
    );
    gh.factory<_i886.IPokemonRepository>(
      () => _i598.PokemonRepositoryImpl(
    ...
    gh.factory<_i743.IRemoveFavoriteUseCase>(
      () => _i1039.RemoveFavoriteUseCase(
    ...
    gh.singleton<_i760.FavoriteBloc>(
      () => _i760.FavoriteBloc(
    ...
    gh.factory<_i962.PokemonListBloc>(
      () => _i962.PokemonListBloc(
        gh<_i1033.IGetPokemonListUseCase>(),
        gh<_i564.AppLogger>(),
      ),
    );
    gh.factory<_i268.PokemonDetailBloc>(
      () => _i268.PokemonDetailBloc(
        gh<_i303.IGetPokemonDetailsUseCase>(),
        gh<_i564.AppLogger>(),
      ),
    );
    gh.factory<_i594.PokemonSearchBloc>(
      () => _i594.PokemonSearchBloc(
