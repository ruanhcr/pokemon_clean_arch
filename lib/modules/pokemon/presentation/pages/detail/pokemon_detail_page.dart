...
import 'package:pokemon_clean_arch/modules/pokemon/presentation/bloc/detail/pokemon_detail_bloc.dart';
...
class _PokemonDetailPageState extends State<PokemonDetailPage> {
  final bloc = GetIt.I.get<PokemonDetailBloc>();
      ...
      child: Scaffold(
        body: BlocBuilder<PokemonDetailBloc, PokemonDetailState>(
          builder: (context, state) {
            return switch (state) {
              PokemonDetailInitial() || PokemonDetailLoading() => const Center(
                child: CircularProgressIndicator.adaptive(),
              ),
              PokemonDetailError(message: var msg) => Center(child: Text(msg)),
              PokemonDetailSuccess(pokemon: var p) => _buildContent(context, p),
            };
          },
        ),
      ),
