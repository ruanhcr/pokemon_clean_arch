...
import 'package:pokemon_clean_arch/modules/pokemon/presentation/bloc/list/pokemon_list_bloc.dart';
...
class _PokemonListPageState extends State<PokemonListPage> {
  final bloc = GetIt.I.get<PokemonListBloc>();
          ...
          slivers: [
            ...
            BlocBuilder<PokemonListBloc, PokemonListState>(
              builder: (context, state) {
                return switch (state) {
                  PokemonListInitial() ||
                  PokemonListLoading() => const SliverFillRemaining(
                    child: Center(child: CircularProgressIndicator.adaptive()),
                  ),
                  PokemonListError(message: var msg) => SliverFillRemaining(
                    child: Center(
                      child: Text(
                        msg,
